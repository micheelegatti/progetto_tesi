...
@section('breadcrumbs')
    ...
    <li>
        <span class="font-semibold text-slate-800 dark:text-slate-200">Importa</span>
    </li>
@endsection
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mt-8">
    ...
    <a href="{{ url('dashboard/destinatari/import/contatto') }}" class="group border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/50 rounded-xl p-8 text-center hover:border-[#722e89] dark:hover:border-[#b05ec9] hover:shadow-md transition flex flex-col items-center justify-center">
        <div class="w-16 h-16 bg-[#f3e8f7] text-[#722e89] dark:bg-[#2a1033] dark:text-[#e2bcf0] rounded-full flex items-center justify-center mb-4 group-hover:scale-110 transition">
            {{-- Icona Utente --}}
    ...
    <a href="{{ url('dashboard/destinatari/import/lista') }}" class="group border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/50 rounded-xl p-8 text-center hover:border-[#722e89] dark:hover:border-[#b05ec9] hover:shadow-md transition flex flex-col items-center justify-center">
        <div class="w-16 h-16 bg-[#f3e8f7] text-[#722e89] dark:bg-[#2a1033] dark:text-[#e2bcf0] rounded-full flex items-center justify-center mb-4 group-hover:scale-110 transition">
